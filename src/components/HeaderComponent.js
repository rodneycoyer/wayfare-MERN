                ...
                <Modal centered isOpen={this.state.isModalOpen} toggle={this.toggleModal}>
                    ...
                    <ModalBody>
                        ...
                        <Button block color="primary" type="submit" size="lg"> Continue </Button>
                            <Button block outline color="secondary" type="submit" style={{ marginTop: "15px"}}> <i class="fa fa-facebook-official fa-2x text-primary pull-left"></i> Continue with Facebook </Button>
                        </div>
                    </ModalBody>
                </Modal>
            </React.Fragment>
